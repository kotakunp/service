...
import { pgTable, text, uuid, timestamp, index, real, pgEnum, primaryKey } from "drizzle-orm/pg-core";
import { pricingTiers, TierNames } from "@/data/priceTiers"
...
export const ProductCustomizationTable = pgTable(
    ...
    textColor: text("text_color")
        .notNull()
        .default("oklch(0.400 0 0)"),
    fontSize: text("font_size")
        .notNull()
        .default("1rem"),
    bannerContainer: text("banner_container")
        .notNull()
        .default("body"),
    isSticky: text("is_sticky")
        .notNull()
        .default("true"),
        createdAt,
        updatedAt,
...
export const TierEnum = pgEnum(
  "tier",
  Object.keys(pricingTiers) as [TierNames]
)
